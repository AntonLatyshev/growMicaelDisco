  ...
  <ul class="dropdown-menu pull-right">
    ...
    <li>
      <table class="table table-striped">
        ...
        <tr>
          <td class="text-center remove"><button type="button" onclick="cart.remove('<?php echo $product['key']; ?>');" title="<?php echo $button_remove; ?>" class="btn btn-remove"><i class="fa fa-times"></i></button></td>
          ...
          <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
            ...
            <?php } ?></td>
          <td class="text-right"><?php echo $product['quantity']; ?> шт.</td>
          <td class="text-right hidden"><?php echo $product['total']; ?></td>
          </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td class="text-right hidden">x&nbsp;1</td>
    ...
    <li>
      <div>
        ...
        <div class="text-center checkoutBlock">
          ...
          <a href="<?php echo $checkout; ?>" class="btn btn-green btn-average"><?php echo $text_checkout; ?></a>
        </div>
      </div>
    </li>
    <?php } else { ?>
