...
<link href="view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.css" type="text/css" rel="stylesheet" media="screen" />
    ...
    <script src="view/javascript/jquery.tablesorter.js" type="text/javascript"></script>
    <script src="view/javascript/jquery.tablesorter.pager.js" type="text/javascript"></script>
...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
	<?php if(isset($exchange1c)){ echo '<li><a href="' . $exchange1c . '">Exchange 1C</a></li> '; } ?> 
