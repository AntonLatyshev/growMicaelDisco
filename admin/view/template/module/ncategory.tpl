...
<div class="container-fluid">
	...
	<input type="text" name="ncategory_bnews_image_width" value="<?php echo $bnews_image_width; ?>" size="3" class="form-control" />
	<?php } else { ?>
	<input type="text" name="ncategory_bnews_image_width" value="80" size="3" />
	<?php } ?>   
	<?php echo $text_bheight; ?> <?php if ($bnews_image_height) { ?>
	<input type="text" name="ncategory_bnews_image_height" value="<?php echo $bnews_image_height; ?>" size="3" class="form-control" />
	<?php } else { ?>
	...
	<input type="text" name="ncategory_bnews_thumb_width" value="<?php echo $bnews_thumb_width; ?>" size="3"class="form-control" />
	<?php } else { ?>
	<input type="text" name="ncategory_bnews_thumb_width" value="230" size="3" />
	<?php } ?>  
	<?php echo $text_bheight; ?> <?php if ($bnews_thumb_height) { ?>
	<input type="text" name="ncategory_bnews_thumb_height" value="<?php echo $bnews_thumb_height; ?>" size="3"class="form-control" />
	<?php } else { ?>
	...
	<tr>
		...
		<td>
			<?php if ($bnews_catalog_limit) { ?>
				<input type="text" name="ncategory_bnews_catalog_limit" value="<?php echo $bnews_catalog_limit; ?>" size="3"class="form-control" />
			<?php } else { ?>
	...
	<tr>
		...
		<td>
			<?php if ($bnews_admin_limit) { ?>
				<input type="text" name="ncategory_bnews_admin_limit" value="<?php echo $bnews_admin_limit; ?>" size="3"class="form-control" />
			<?php } else { ?>
	...
	<tr>
		...
		<td>
			<?php if ($bnews_headlines_url) { ?>
				<input type="text" name="ncategory_bnews_headlines_url" value="<?php echo $bnews_headlines_url; ?>" size="25"class="form-control" />
			<?php } else { ?>
				<input type="text" name="ncategory_bnews_headlines_url" value="blog-headlines" size="25"class="form-control" />
			<?php } ?>  
		</td>	
	</tr>	
	<tr>
		...
		<td>
			<?php if ($bnews_desc_length) { ?>
				<input type="text" name="ncategory_bnews_desc_length" value="<?php echo $bnews_desc_length; ?>" size="3" class="form-control" />
			<?php } else { ?>
				<input type="text" name="ncategory_bnews_desc_length" value="600" size="3" class="form-control" />
			<?php } ?>  
		</td>	
	</tr>	
		</table>	
