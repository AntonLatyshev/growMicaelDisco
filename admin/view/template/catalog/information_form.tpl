        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <?php $i = 1; if ( !empty($custom_fields) && !empty($custom_fields[$language['language_id']]) ) { foreach ( $custom_fields[$language['language_id']] as $custom_field ) { ?>
                    <div id="custom-field-item-<?php echo $language['language_id']; ?>-<?php echo $i; ?>">
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="name-custom-field-<?php echo $language['language_id']; ?>-<?php echo $i; ?>">Название/Тип:</label>
                        <div class="col-sm-10">
                          <div class="row">
                            <div class="col-sm-8 col-xs-12">
                              ...
                              <input type="text"
                                     ...
                                     id="name-custom-field-<?php echo $language['language_id']; ?>-<?php echo $i; ?>"
                                     class="form-control" />
                            </div>
                            ...
                            <div class="col-sm-1 col-xs-12 text-right">
                              <button type="button" id="delete-custom-fields" data-id="<?php echo $i; ?>" data-language="<?php echo $language['language_id']; ?>" data-toggle="tooltip" title="Удалить данную группу" class="btn btn-warning"><i class="fa fa-minus"></i></button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <?php if ($custom_field['type'] == 'text') { ?>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="text-custom-field-<?php echo $language['language_id']; ?>-<?php echo $i; ?>">Значение:</label>
                          <div class="col-sm-10">
                            <input type="text"
                                   ...
                                   id="text-custom-field-<?php echo $language['language_id']; ?>-<?php echo $i; ?>"
                                   class="form-control" /></div>
                        </div>
                      <?php } ?>
                      <?php if ($custom_field['type'] == 'textarea') { ?>
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="textarea-custom-field-<?php echo $language['language_id']; ?>-<?php echo $i; ?>">Значение:</label>
                          <div class="col-sm-10">
                          <textarea rows="4"
                                    name="custom_field[<?php echo $language['language_id']; ?>][<?php echo $i; ?>][value]"
                                    id="textarea-custom-field-<?php echo $language['language_id']; ?>-<?php echo $i; ?>"
                      ...
                      <?php if ($custom_field['type'] == 'image') { ?>
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            ...
                            <input type="hidden" name="custom_field[<?php echo $language['language_id']; ?>][<?php echo $i; ?>][value]" value="<?php echo isset($custom_field['value']) ? html_entity_decode($custom_field['value'], ENT_QUOTES, 'UTF-8') : ''; ?>" id="input-image-<?php echo $language['language_id']; ?>-<?php echo $i; ?>" />
                          </div>
                        </div>
                      <?php } ?>
                      <hr>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-top"><span data-toggle="tooltip" title="Показывать меню в шапке сайта">Шапка</span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($top) { ?>
...
$('#input-description<?php echo $language['language_id']; ?>').summernote({ height: 300 });
    ...
    <?php $i = 1; foreach ( $custom_fields[$language['language_id']] as $custom_field ) { ?>
    $('#textarea-custom-field-<?php echo $language['language_id']; ?>-<?php echo $i; ?>').summernote({ height: 200 });
    <?php $i++; } ?>
    <?php } ?>
<?php } ?>
//--></script>
