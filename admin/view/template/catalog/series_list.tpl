        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td class="text-right">
                            <span>
                                    <a id="addSeries" class="btn btn-success">
          ...
          <table class="table table-striped table-bordered table-hover tablesorter" id="myTable1">
            <thead>
              <tr>
            ...
            <tbody>
            	...
            	<?php if(isset($series)) { ?>
                    ...
                    <tr series-id="<?php print $single['series_id']; ?>" class="series_record">
                        <td class="text-left">
                                <span><?php print $single['name']; ?></span>
                        </td>  
                        <td class="text-right">
                                <span>
                                        <a href="<?php print $single['href']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i>Список продуктов</a>&nbsp;
                                        <button data="<?php print $single['series_id']; ?>" class="btn btn-danger pull-right removeSeries" type="button"><i class="fa fa-trash-o"></i> Удалить</button>
                                </span>
                        </td>  
                    </tr>
                    <?php } ?>
            ...
            <div id="pager" class="pager">
                <form>
                    <img src="view/image/first.png" class="first"/>
                    <img src="view/image/prev.png" class="prev"/>
                    <input type="text" class="pagedisplay hidden"/>
                    <select class="gotoPage" title="Select page number"></select>
                    <img src="view/image/next.png" class="next"/>
                    <img src="view/image/last.png" class="last"/>
...
//                .tablesorterPager({container: $("#pager")});
    ...
    function del(iddel) {
            console.log(iddel);
            $.ajax({
                    url: '<?php print html_entity_decode($del_series_href); ?>',
                    dataType: 'json',
                    type: 'post',
                    data: {series_id: iddel},
                    beforeSend: function(){
                            console.log('show preloader');
                    },
                    complete: function(){
