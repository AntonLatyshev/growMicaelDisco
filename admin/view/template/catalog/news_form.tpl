...
<div class="tab-pane" id="tab-custom">
	...
	<ul class="nav nav-tabs hidden" id="languagesc">
                <?php foreach ($languages as $language) { ?>
	...
	<table id="video" class="table table-striped table-bordered table-hover">
            ...
            <tbody id="video-row<?php echo $video_row; ?>">
              <tr>
                ...
                <td class="text-left"><input class="form-control" type="text" name="news_video[<?php echo $video_row; ?>][width]" value="<?php echo $video['width']; ?>" size="3" />
				<input class="form-control" type="text" name="news_video[<?php echo $video_row; ?>][height]" value="<?php echo $video['height']; ?>" size="3" />
				</td>
                <td class="text-right"><input class="form-control" type="text" name="news_video[<?php echo $video_row; ?>][sort_order]" value="<?php echo $video['sort_order']; ?>" size="2" /></td>
                <td class="text-left"><a onclick="$('#video-row<?php echo $video_row; ?>').remove();" class="btn btn-danger"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $video_row++; ?>
            <?php } ?>
	...
	<table id="gallery" class="table table-striped table-bordered table-hover">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                ...
                <td class="text-right"><input class="form-control" type="text" name="news_gallery[<?php echo $image_row; ?>][sort_order]" value="<?php echo $news_image['sort_order']; ?>" size="2" /></td>
                <td class="text-left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="btn btn-danger"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $image_row++; ?>
            <?php } ?>
