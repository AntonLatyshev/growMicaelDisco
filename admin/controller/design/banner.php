...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
		...
		foreach ($banner_images as $banner_image) {
			...
			/*if (is_file(DIR_IMAGE . $banner_image['image_en'])) {
				$image_en = $banner_image['image_en'];
				$thumb_en = $banner_image['image_en'];
			} else {
				$image_en = '';
				$thumb_en = 'no_image.png';
			}

			if (is_file(DIR_IMAGE . $banner_image['image_ua'])) {
				$image_ua = $banner_image['image_ua'];
				$thumb_ua = $banner_image['image_ua'];
			} else {
				$image_ua = '';
				$thumb_ua = 'no_image.png';
			}*/
			...
			$data['banner_images'][] = array(
				...
				/*'thumb_en'                 => $this->model_tool_image->resize($thumb_en, 100, 100),
				'thumb_ua'                 => $this->model_tool_image->resize($thumb_ua, 100, 100),*/
